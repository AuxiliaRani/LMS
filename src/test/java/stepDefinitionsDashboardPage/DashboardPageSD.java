...
public class DashboardPageSD {
	...
	public void admin_is_on_page_for_dashboard_validation(String string) {
	...
	public void admin_should_see_as_header_for_dashboard_page(String string) {
	...
	public void admin_should_receive_error_for_the_dashboard_page_link(String string) {
	...
	public void admin_should_see_as_title_on_dashboard_page(String string) {
	...
	public void admin_should_see_correct_spelling_on_navigation_bar_text_for_dashboard_page() {
	...
	public void admin_should_see_in_the_5th_place(String string) {
	...
	public void admin_should_see_in_the_6th_place(String string) {
	...
	public void admin_should_see_in_the_7th_place(String string) {
	...
	public void admin_should_see_in_the_8th_place(String string) {
